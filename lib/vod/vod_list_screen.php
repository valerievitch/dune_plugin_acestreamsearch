    ...
    implements UserInputHandler
{
    ...
    {
        return $this->vod->get_vod_list_folder_views($plugin_cookies);
    }
        ...
        if ($this->vod->is_favorites_supported())
        {
            $add_favorite_action =
                UserInputHandlerRegistry::create_action(
                    $this, 'add_favorite');
            $add_favorite_action['caption'] =
                T::t('vod_action_my_movies');
    ...
    public function handle_user_input(&$user_input, &$plugin_cookies)
    {
        ...
        if ($user_input->control_id == 'popup_menu')
        {
            ...
            $add_favorite_action =
                UserInputHandlerRegistry::create_action(
                    $this, 'add_favorite');
            $caption = T::t('vod_action_add_to_my_movies');
            $menu_items[] = array(
        ...
        else if ($user_input->control_id == 'add_favorite')
        {
            ...
            if ($is_favorite)
            {
                return ActionFactory::show_title_dialog(
                    T::t('vod_movie_already_my_movie'));
            }
            else
            {
